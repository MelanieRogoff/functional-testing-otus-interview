...
(async function assessment() {
    ...
    try {
        ...
        console.log('---Step 1.i, part 4: Click through the third field under the Title column 3 times--- \n');
            ...
            const closeThirdBtn = await driver.findElement(By.xpath("//div[@class='reveal otus-new-modal small instructions-modal']//div[@class='otus-new-modal__close-button smallX ng-star-inserted']//*[local-name()='svg']"), 2000);
        ...
        console.log('---Step 1.i, part 5b: Click through the second due date field item 3 times--- \n');
            ...
            const closeSecondDueBtn = await driver.findElement(By.xpath("//div[@class='reveal otus-new-modal small instructions-modal']//div[@class='otus-new-modal__close-button smallX ng-star-inserted']//*[local-name()='svg']"), 8000);
...
//NOW THE ERRORS ARE HERE -- LEFT OFF HERE FOR DEBUGGING. 
        ...
        console.log('---Step 1.i, part 5c: Click through the third due date field item 3 times--- \n');
            await driver.wait(until.elementLocated(By.xpath("//tr[3]//td[3]")), 7000);
            const thirdDueBtn = await driver.findElement(By.xpath("//tr[3]//td[3]"));   
            const closeThirdDueBtn = await driver.findElement(By.xpath("//div[@class='reveal otus-new-modal small instructions-modal']//div[@class='otus-new-modal__close-button smallX ng-star-inserted']"), 2000);
        ...
        console.log('---Step 1.i, part 6a: Click through the first Points field item 3 times--- \n');
            ...
            const closePt1Btn = await driver.findElement(By.xpath("//div[@class='reveal otus-new-modal small retake-assessment-modal']//div[@class='otus-new-modal__close-button smallX ng-star-inserted']//*[local-name()='svg']//*[name()='path' and contains(@class,'close-butt')]"), 2000);
        ...
        console.log('---Step 1.i, part 6b: Click through the second Points field item 3 times--- \n');
            ...
            const closePt2Btn = await driver.findElement(By.xpath("//div[@class='reveal otus-new-modal small instructions-modal']//div[@class='otus-new-modal__close-button smallX ng-star-inserted']//*[local-name()='svg']//*[name()='path' and contains(@class,'close-butt')]"), 2000);
        ...
        console.log('---Step 1.i, part 7: Click through each Status field item 3 times each--- \n');
            ...
            const closeStat1Btn = await driver.findElement(By.xpath("//div[@class='reveal otus-new-modal small retake-assessment-modal']//div[@class='otus-new-modal__close-button smallX ng-star-inserted']//*[local-name()='svg']"), 2000);
